      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
				<tr>
						...
						<td><select name="stripe_environment">
				...
				<tr>
						<td><span class="required">*</span> <?php echo $entry_3d_secure_supported; ?></td>
						<td>
								...
								<?php } ?>
								<br/><br/>
								<?php if ($error_3d_secure_supported) { ?>
									<span class="error"><?php echo $error_3d_secure_supported; ?></span>
								<?php } ?>
						</td>
				</tr>
				<tr>
				...
				<tr>
						...
						<td><select name="stripe_order_success_status_id">
				...
				<tr>
						...
						<td><select name="stripe_order_failed_status_id">
							 <?php foreach ($order_statuses as $order_status) { ?>
